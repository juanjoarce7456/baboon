...
\begin{document}
    ...
    \part{Desarrollo}
        ...
        \chapter{Diseño de \nombreFramework \  Framework}
            \include{./sections/baboon_framework/Eventos}
            \include{./sections/baboon_framework/ModosDeSincronizacion}
            \include{./sections/baboon_framework/TasksHappenings}
            \include{./sections/baboon_framework/GuardProviders}
            \include{./sections/baboon_framework/RelacionEventosLogicosEventosDeAccionControladoresDeAccion}
