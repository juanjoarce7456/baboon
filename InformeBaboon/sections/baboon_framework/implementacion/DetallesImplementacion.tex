...
\begin{figure}[H]
    \centering
	\includegraphics[width=0.85\textwidth]{diagrama_componentes}
...
\begin{itemize}
 ...
 \begin{figure}[H]
    \centering
	\includegraphics[width=\textwidth]{secuencia_implementacion_ejecucion_main}
...
\end{figure}
  ...
  Figura~\ref{fig:diagrama_secuencia_implementacion_ejecucion_task_controller}):
  	\begin{enumerate}
  	  ...
  	  asociadas. 
  	  \item El objeto DummyThread establece en el monitor de Petri, para cada
  	  guarda asociada, el valor correspondiente que retornan los métodos GuardProvider.
...
\begin{figure}[H]
    \centering
	\includegraphics[width=\textwidth]{secuencia_implementacion_ejecucion_task_controller}
...
\end{figure}
  ...
  Figura~\ref{fig:diagrama_secuencia_implementacion_ejecucion_happening_controller}):
  	\begin{enumerate}
  	  ...
  	  \item Se ejecutan los métodos GuardProvider que corresponden a las guardas
  	  asociadas.
  	  \item El objeto HappeningControllerSincronizer establece en el monitor de
  	  Petri, para cada guarda asociada, el valor correspondiente que retornan los
  	  métodos GuardProvider.
  	  \item Se obtienen del tópico los nombres de las transiciones de aviso de
  	  finalización de ejecución.
...
\begin{figure}[H]
    \centering
	\includegraphics[width=\textwidth]{secuencia_implementacion_ejecucion_happening_controller}
	\caption{Diagrama de Secuencia de la Ejecución Implementada de un
	HappeningController}
