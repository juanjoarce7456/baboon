...
objeto \mint{java}|Transition| y otra por nombre de transición.
...
\mint{java}|fireTransition()| sobre una instancia de la clase
\mint{java}|PetriMonitor|.
...
El concepto de disparo no-perenne es útil para modelar condiciones no
...
grave, que que provoca un error \mint{java}|IllegalTransitionFiringError|.
\end{framed}
...
\begin{itemize}
    ...
    \mint{java}|TransitionsPolicy| al constructor de \mint{java}|PetriMonitor|.
...
\mint{java}|TransitionsPolicy| puede ser usada como política de transiciones.
