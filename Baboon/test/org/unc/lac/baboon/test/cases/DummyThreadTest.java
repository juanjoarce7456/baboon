...
public class DummyThreadTest {
    ...
    final String petriNetFile = "/pnml01.pnml";
    final String petriNetFile_02 = "/pnml02.pnml";
    ...
    public void simpleTaskControllerShouldRunCorrectlyOnDummyThread() throws Exception {
        ...
        final DummyThread dummyThreadInstance = new DummyThread(taskSubscription, petriCore);
