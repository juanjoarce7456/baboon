...
public class TasksAndHappeningHandlersSubscriptionTest {
     ...
     * <li>Then the {@link HappeningHandlerSubscription} subscriptions Map should
     * contain a {@link HappeningHandlerSubscription} with the object instance and the
    ...
    public void subscribingAnExistingHappeningHandlerToAnExistingTopicShouldGetRegisteredInConfigTest() {
        ...
        try {
            ...
            Pair<Object,Method> testKey = new Pair<Object,Method> (mockController, MethodDictionary.getMethod(mockController, happeningHandlerMethod));
     ...
     * {@link TaskSubscription} with the object instance and the method subscribed as
     * a map's key</li>
    ...
    public void subscribingAnExistingTaskToAnExistingTopicShouldShouldGetRegisteredInConfigTest() {
        ...
        try {
            ...
            Map<Pair<Object,Method>, AbstractTaskSubscription> subscriptionsMap = baboonConfig.getSubscriptionsMap();
            Pair<Object,Method> testTOKey = new Pair<Object,Method>(mockController, MethodDictionary.getMethod(mockController, taskMethod));
            assertEquals(1, subscriptionsMap.size());
     ...
     * combinations</li>
     * <li>Then all the {@link HappeningHandlerSubscription} and {@link TaskSubscription}
     ...
     * <li>And topic1 has an empty permission string</li>
     * <li>And I add the topics configuration to the Framework</li>
     * <li>When I subscribe a {@link HappeningHandlerSubscription} to topic1</li>
     * <li>Then the {@link HappeningHandlerSubscription} subscriptions Map should
     * contain a {@link HappeningHandlerSubscription} with the object instance and the
     * method subscribed as a map's key</li>
     * <li>And the {@link HappeningHandlerSubscription} subscriptions Map should
     ...
     * <li>And topic2 has not the permission field</li>
     * <li>And I add the topics configuration to the Framework</li>
     * <li>When I subscribe a {@link HappeningHandlerSubscription} to topic2</li>
     * <li>Then the {@link HappeningHandlerSubscription} subscriptions Map should
     * contain a {@link HappeningHandlerSubscription} with the object instance and the
     * method subscribed as a map's key</li>
     * <li>And the {@link HappeningHandlerSubscription} subscriptions Map should
     ...
     * requires no parameters annotated with {@link GuardProvider#value()}
     * "g2"</li>
     * <li>When I subscribe a {@link HappeningHandlerSubscription} to topic3</li>
     * <li>Then the {@link HappeningHandlerSubscription} subscriptions Map should
     * contain a {@link HappeningHandlerSubscription} with the object instance and the
     * method subscribed as a map's key</li>
     * <li>And the {@link HappeningHandlerSubscription} subscriptions Map should
     * contain the {@link Topic} as value for the key</li>
     * <li>And {@link HappeningHandlerSubscription#getGuardCallback(String)} should
    ...
    public void subscribingAbstractTaskWithGuardProvidersToTopicWithGuardCallbackShouldGetRegisteredInConfigTest() {
        ...
        try {
            ...
            assertEquals(1, subscriptionsMap.size());
            assertTrue(subscriptionsMap.keySet().contains(testHHOKey));
            assertEquals(providerMethod1, subscriptionsMap.get(testHHOKey).getGuardCallback("g1").getName());
            assertEquals(providerMethod2, subscriptionsMap.get(testHHOKey).getGuardCallback("g2").getName());
     ...
     * <li>When I subscribe a {@link HappeningHandlerSubscription} to topic4</li>
     * <li>Then a {@link NotSubscribableException} exception should be
     * thrown</li>
     */
    @Test
